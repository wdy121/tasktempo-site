...
export const siteLinks = {
  download:
    "https://github.com/wdy121/tasktempo-site/releases/download/V2.0/TaskTempo.exe",
  downloadFile:
    "https://github.com/wdy121/tasktempo-site/releases/download/V2.0/TaskTempo.exe" as const,
